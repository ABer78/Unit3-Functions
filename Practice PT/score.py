...
if __name__ == "__main__":
    ...
    try:
        ...
        if result == expected:
            print(
                "  ✅ Test 2.2 PASSED: create_song('Yesterday', artist='The Beatles')"
            )
            task2_points += 6
        else:
    ...
    try:
        ...
        expected = {
            "name": "Road Trip",
            "songs": {"song1": 5, "song2": 10, "song3": 3},
            "total_plays": 18,
        }
        if result == expected:
        ...
        expected = {
            "name": "Chill Vibes",
            "songs": {"relaxing": 20, "ambient": 15},
            "total_plays": 35,
        }
        if result == expected:
            print(
                "  ✅ Test 4.2 PASSED: build_playlist('Chill Vibes', relaxing=20, ambient=15)"
            )
            task4_points += 8
        else:
        ...
        if result == expected:
            print(
                "  ✅ Test 4.3 PASSED: build_playlist('Empty Playlist') handles empty"
            )
            task4_points += 7
        else:
        ...
        if result == expected:
            print(
                "  ✅ Test 4.4 PASSED: build_playlist('One Hit Wonder', hit_song=100)"
            )
            task4_points += 7
        else:
